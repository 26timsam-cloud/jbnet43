            ...
            <Reveal key={service.title} delay={i * 100} direction="up">
              ...
              >
                ...
                <div className="relative h-56 overflow-hidden">
                  ...
                  <div
                    className="absolute bottom-4 right-4 h-10 w-10 rounded-2xl flex items-center justify-center text-white opacity-90 transition-transform duration-300 group-hover:scale-110"
                    style={{ background: service.color }}
                  >
